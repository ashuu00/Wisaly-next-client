...
export default function Footer() {
    //Custom Footer Links
    const CustomLink = ({ route, title }: { route: string; title: string }) => (
        <Link to={route ? route : '#'} color="green.100" _hover={{ color: 'blue.100' }}>
            {title}
        </Link>
    );
    ...
    return (
        <Box as="footer" className="myFooter">
            <Box bg="teal.900" w="100%" color="yellow.50" pt={5}>
                <Flex justifyContent="space-around" alignItems="flex-start" flexWrap="wrap" p={5}>
                    ...
                    <Box w="320px" textAlign={{ base: 'center', md: 'left' }}>
                        <Heading as="h3" size="xl" color="teal.500" mb="1.5rem">
                            Stay Updated
                        </Heading>
                    ...
                    <Box w="320px" textAlign={{ base: 'center', md: 'left' }}>
                        <Text as="u" fontSize="xl" color="teal.500">
                            CONNECT WITH US
                        </Text>
                        ...
                        <VStack
                            ...
                            <Link color="green.100" fontSize="lg">
                                Email: ashu28anurag@gmail.com
                            </Link>
                            <Link color="green.100" fontSize="lg">
                                Address: Abhimanyu Apartments <br /> Delhi-110096
                            </Link>
                ...
                <Center mt={5}>
                    <Link mx={5} fontSize="sm" color="teal.500" _hover={{ color: 'green.100' }}>
                        Terms and Conditions
                    </Link>
                    <Link mx={5} fontSize="sm" color="teal.500" _hover={{ color: 'green.100' }}>
                        Privacy Policy
                    </Link>
                    <Text mx={5} fontSize="sm" color="green.100">
                        Copyright &copy; {new Date().getFullYear()} Wisaly. All Rights Reserved.
                    </Text>
                </Center>
            </Box>
        </Box>

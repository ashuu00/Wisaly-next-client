...
export default function ProductHeading({ title, ...props }): JSX.Element {
    return (
        <Box {...props} p={5}>
            <Heading size="2xl">{title}</Heading>
            <Flex mt={3}>
                <Ratings rating={3.403} widgetDimensions="25px" widgetSpacings="15px">
            ...
            <Text fontWeight="semi-bold" mt={{ base: 4, md: 6 }} color="green.400" fontSize="2xl">
                20% Discount
            </Text>

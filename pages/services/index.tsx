        ...
        <Box w="100%" p="2rem" display="flex" bg="gray.50" position="relative">
            ...
            <Box w="32.5%"  h="100vh" p="1rem"  >
                ...
                <HStack spacing="0" justify="center" fontWeight="bold">
                    ...
                    textAlign="center" py="0.1rem">
                        <Text fontSize="md"  >Orders</Text>
                        <Text fontSize="md"  >1200</Text>
                    </Box>
                    <Box borderRadius="5px" w="33%" bg="gray.100"
                ...
                <Flex justify="space-around" mt="2rem" >
                    <Button colorScheme="teal" fontSize="xl" w="40%">Book Now</Button>
                    <Button colorScheme="pink" fontSize="xl" w="40%"> Follow </Button>
                </Flex>
                <Box w="100%" my="2rem" position="relative">
                    ...
                    <Text fontSize="md" mt="1rem" fontWeight="regular" color="gray.600" >Use this to style the whole container. 
                    For example add padding to allow the "dots" or "arrows" to go to other 
                    places without being overflown.</Text>
                </Box>
